...
- 但是别人的东西必须得适用于自己才好，大佬的插件比较精简，但是样式不是我喜欢的，我想要追加css进去，这样可以随意替换css，其次本人主营php，博客是用golang开发的，python插件有点突兀，所以这也让我重新拾起go，开发了一个类似他的那个插件的golang版本[v2free机场](https://v2free.net/)
